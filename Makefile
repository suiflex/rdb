...
BE_PKGS = rdb-core rdb-connstore rdb-driver-postgres rdb-driver-mysql rdb-driver-redis rdb-driver-mongo rdb-driver-sqlite rdb-driver-cassandra rdb-driver-mssql rdb-driver-oracle rdb-driver-clickhouse
FE_PKG  = rdb
