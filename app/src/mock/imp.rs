...
//! design, and routes "connect" to the in-process MockDriver.
//!
//! Compiled only under the `mock` feature; `super::mock_mode` is the always-on
//! gate that decides whether any of this runs.
...
/// The connection list from design/connections.png: WORK 3 · LOCAL 4 ·
