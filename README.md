...
<p align="center">
  <strong>Native cross-platform database manager.<br>PostgreSQL · MySQL · Redis · MongoDB · SQLite · Cassandra · SQL Server — one binary, no Electron.</strong>
</p>
...
2. Type SQL (PostgreSQL/MySQL/SQL Server), CQL (Cassandra), a Redis command (e.g. `GET key`), or a MongoDB JSON operation in the query editor.
...
Active development. Ships 7 engines (PostgreSQL, MySQL, Redis, MongoDB, SQLite, Cassandra, SQL Server); planned expansion to ~20 (ClickHouse, BigQuery, Oracle, and more).
