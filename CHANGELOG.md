...
## RDB: [0.48.1](https://github.com/suiflex/rdb/compare/v0.48.0...v0.48.1) (2026-09-25)


### Bug Fixes

* **app:** stop the Settings update card aborting mid-install ([2158312](https://github.com/suiflex/rdb/commit/2158312cafb9efa50de094fb2722ecaf15baddb7))

## RDB: [0.48.0](https://github.com/suiflex/rdb/compare/v0.47.1...v0.48.0) (2026-09-25)
...
## RDB: [0.47.1](https://github.com/suiflex/rdb/compare/v0.47.0...v0.47.1) (2026-09-21)


### Bug Fixes

* **app:** stop the update install click aborting the app ([f6cc4af](https://github.com/suiflex/rdb/commit/f6cc4af2db5137b475289e960444f6d3a8ac661c))
* **app:** swap the app bundle in one step when installing ([ef181ab](https://github.com/suiflex/rdb/commit/ef181ab90dd0a20683a1a36d8a3a3f537e780e3f))

## RDB: [0.47.0](https://github.com/suiflex/rdb/compare/v0.46.1...v0.47.0) (2026-09-18)


### App Features

* **app:** improve query workspace UX ([de30ae9](https://github.com/suiflex/rdb/commit/de30ae9f354cd74c8ee64dbfa68da6826eb944bc))


### Bug Fixes

* **app:** accept mongosh find call in Mongo filter box ([714ebf7](https://github.com/suiflex/rdb/commit/714ebf7ac16e195014bd4bbc8b7abd9bdbead96e))
* **app:** cover dialect-completion review gaps (@arianao19) ([5ca84ac](https://github.com/suiflex/rdb/commit/5ca84ac9603558da3a718716c58bd4f40aff4a20))
* **app:** hint the expected shape on invalid Mongo find JSON ([02a1705](https://github.com/suiflex/rdb/commit/02a1705204b5d5ff2b6e6a7948a3833212aaa7e2))
* **app:** route SQL keyword completion from engine dialect, not language (@arianao19) ([6758ac7](https://github.com/suiflex/rdb/commit/6758ac7695ca0b2a3ea0de874a78e1ffe719d399))
* **packaging:** use postflight_steps in homebrew cask (@wahyuakbarwibowo) ([218941d](https://github.com/suiflex/rdb/commit/218941d6f9747526acf7c4d5b81b8477f7fa0b8f))
...
## RDB: [0.46.1](https://github.com/suiflex/rdb/compare/v0.46.0...v0.46.1) (2026-09-12)


### Bug Fixes

* **website:** send GitHub token when fetching release data ([cac64a9](https://github.com/suiflex/rdb/commit/cac64a9ac0d4fe1ceed9506e8c577a2b8bb23861))

## RDB: [0.46.0](https://github.com/suiflex/rdb/compare/v0.45.0...v0.46.0) (2026-09-12)
...
* **app:** support multiple simultaneous connections (@arianao19) ([3314e13](https://github.com/suiflex/rdb/commit/3314e13b44db091f1fec8982822451a2c84607f5))
...
* **app:** decide statement splitting from the engine's query language (@arianao19) ([14a30ae](https://github.com/suiflex/rdb/commit/14a30ae4a415c5758a3efa1f431c581deb0a9401))
* **app:** derive from-table fallback flag from columns not refs (@arianao19) ([52c57d6](https://github.com/suiflex/rdb/commit/52c57d6e493c047b29a57ed5999f882682db04d5))
...
* **app:** resolve cancel/evict driver by connection id, not current (@arianao19) ([3b9ea02](https://github.com/suiflex/rdb/commit/3b9ea02c581c9482bc1b75121343ecdfdc05efa1))
* **app:** scope bare-column completion to FROM/JOIN tables (@arianao19) ([680f302](https://github.com/suiflex/rdb/commit/680f302a73147b280886b9303c68c4650f763fbf))
...
* the sidebar live dot and the disconnect flow's live check both (@arianao19) ([3314e13](https://github.com/suiflex/rdb/commit/3314e13b44db091f1fec8982822451a2c84607f5))


### Performance Improvements

* **app:** make the eviction sweep's id set a HashSet (@arianao19) ([797bff8](https://github.com/suiflex/rdb/commit/797bff8d3ac4ccfa3da9eb95178dc85e8725c26f))
...
* @arianao19 made their first contribution

## RDB: [0.45.0](https://github.com/suiflex/rdb/compare/v0.44.1...v0.45.0) (2026-09-10)


### App Features

* **driver-oracle:** name the way out of an undecodable column type ([1814a90](https://github.com/suiflex/rdb/commit/1814a90065ae92cd91deac36ae858d6d313676d8))
* **website:** add Google Analytics 4 tracking (@wahyuakbarwibowo) ([ab3df1a](https://github.com/suiflex/rdb/commit/ab3df1a2d259cabd2a323ebd6e19b13c8eafa3b2))


### Driver Features

* **driver-oracle:** replace ODPI-C with Oracle's oracledb driver ([b69cb0b](https://github.com/suiflex/rdb/commit/b69cb0bab02759a0d933395d50bc821328cf957d))


### Bug Fixes

* **driver-oracle:** correct three column-rendering defects from review ([46813b8](https://github.com/suiflex/rdb/commit/46813b8a85d6d6c39682ea652c27bb56b0e7291d))
* **driver-oracle:** keep a declared TIMESTAMP(0) out of the header as (6) ([75c7e5c](https://github.com/suiflex/rdb/commit/75c7e5c7ab355058f06c3c9f4dbe76d2e70e0760))
* **driver-oracle:** show the stored local time for zoned timestamps ([ec7e151](https://github.com/suiflex/rdb/commit/ec7e151cf77f787ec41ed6c2753019250171bf2b))
...
## RDB: [0.44.1](https://github.com/suiflex/rdb/compare/v0.44.0...v0.44.1) (2026-09-01)


### Bug Fixes

* **app:** derive the editor char advance from the font metric ([47af0bb](https://github.com/suiflex/rdb/commit/47af0bba60ce0bf99be3b4e57aa8210f4730f714))
* **app:** drop the trailing newline when copying result cells ([f1ff9e1](https://github.com/suiflex/rdb/commit/f1ff9e13f8f354a83c3565c59ccb89ffe90a11f2))
* **app:** map an editor drag through folded lines ([76345e5](https://github.com/suiflex/rdb/commit/76345e5058b4e85727a50ece3c63c01fc41c9f5c))
* **app:** only unwrap auto-inserted pairs on backspace ([2787a34](https://github.com/suiflex/rdb/commit/2787a34e670d7d18a033e8e2e134526ad5876066))
* **app:** paint editor tabs as spaces instead of tofu ([f129146](https://github.com/suiflex/rdb/commit/f12914686cce71a47609f31ea47f37f840842665))
* **app:** require the pair to still be there before unwrapping it ([d14057a](https://github.com/suiflex/rdb/commit/d14057af81cbf491410eceda9b5467348b2c8287))

## RDB: [0.44.0](https://github.com/suiflex/rdb/compare/v0.43.0...v0.44.0) (2026-08-29)
...
## RDB: [0.43.0](https://github.com/suiflex/rdb/compare/v0.42.0...v0.43.0) (2026-08-27)
